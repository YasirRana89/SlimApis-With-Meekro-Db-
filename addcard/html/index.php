            ...
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#getrecords" class="btn1" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Get All Records</span></a>						
					</div>
                </div>
            </div>
...
//        data: "{}",
        ...
        success: function (result) {			
			...
			for(var r=0; r<result.data.length; r++){
				...
				trHTML += '<td><a href="http://localhost/addcard/edit.php" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>';
                trHTML += '<a  class="delete" data-id="'+item.id+'" href="#" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>';
			}
